  ...
  <div class="w-full h-screen flex justify-center items-center">
    <div class="w-3/6 h-full flex flex-col justify-center gap-8 pr-32">
      ...
      <p class="text-black text-xl font-body">
        Somos un grupo de profesionales que valoran la creatividad y entusiasmo
        a la hora de crear. Combinamos distintos talentos para formar los
        equipos indicados para cada proyecto.
      </p>
    </div>
    <div class="w-3/6 h-full flex justify-center items-center px-32">
      <AppOurADNCarousel />
    </div>
  </div>
</template>
